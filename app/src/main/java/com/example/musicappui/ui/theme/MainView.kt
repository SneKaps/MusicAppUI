        ...
        if (currentScreen is Screen.DrawerScreen || currentScreen == Screen.BottomScreen.Home){
            BottomNavigation(modifier = Modifier.wrapContentSize()) {
                screensInBottom.forEach {
                    ...
                    Log.d("Navigation", "Item: ${item.bTitle}, Current Route: $currentRoute, is Selected: ${item.bRoute}")
    ...
    Box(modifier = Modifier
        ...
        Column(modifier = Modifier
            ...
            Row(modifier = Modifier.padding(8.dp)){
                Icon(modifier = Modifier.padding(end = 8.dp), imageVector = Icons.Default.Settings, contentDescription = "settings")
                Text("Settings")
            }
            Row(modifier = Modifier.padding(8.dp)){
                Icon(modifier = Modifier.padding(end = 8.dp), imageVector = Icons.Default.Share, contentDescription = "settings")
                Text("Share")
            }
            Row(modifier = Modifier.padding(8.dp)){
